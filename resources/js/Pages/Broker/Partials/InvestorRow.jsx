...
// resources/js/Pages/Broker/Partials/InvestorRow.jsx
...
const InvestorRow = ({ item, onUpdate }) => {
    return (
        <tr className="hover:bg-white/[0.02] transition-all group border-b border-white/5">
            <td className="p-6">
                <div className="font-black text-white text-[15px]">{item.name}</div>
                <div className="text-white/30 text-[10px] mt-1 uppercase tracking-tighter">
            ...
            <td className="p-6">
                <div className="text-white text-[13px] font-bold">{item.capital_range || 'غير محدد'}</div>
                <div className="text-white/40 text-[11px] mt-1 uppercase tracking-widest text-[9px]">{item.investment_goal}</div>
            </td>

            <td className="p-6 text-center">
                <div className="inline-block px-3 py-1 rounded-lg bg-white/5 border border-white/10 text-[12px] text-white/70 font-mono">
                    {item.area} <span className="text-[9px]">م²</span>
                </div>
            </td>

            <td className="p-6 text-center">
                <span className="material-symbols-outlined text-white/10">no_photography</span>
            </td>
