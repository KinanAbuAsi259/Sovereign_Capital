...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    // السطر المحدث: توجيه موحد لأي مستخدم مسجل (أدمن أو وسيط)
    const dashboardRoute = auth.user ? "broker.dashboard" : null;
        ...
        <>
            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen ...">
                <div className="sm:fixed sm:top-0 sm:right-0 p-6 text-end">
                    {auth.user ? (
                        <Link
                            href={route(dashboardRoute)} // سيذهب دائماً لـ /bdashboard
