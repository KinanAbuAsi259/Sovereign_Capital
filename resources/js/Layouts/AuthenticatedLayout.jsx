...
export default function Authenticated({
    ...
    const handleLogout = (e) => {
        ...
        router.post(
            ...
            {},
            {
                // هذا الخيار يضمن تنظيف حالة Inertia بالكامل
                onFinish: () => {
                    window.location.href = "/"; // إعادة توجيه صلبة تمسح كل الـ Cache والـ States
                },
            },
        );
    };
    ...
    `}</style>
            ...
            <div className="fixed inset-0 pointer-events-none z-[50] border-[4px] border-accent/20">
                        ...
                        <nav className="space-y-4 flex-1">
                                ...
                                <Link
                                    ...
                                    className={`flex items-center gap-4 p-3 rounded-xl transition-all group ${
                                        route().current("admin.dashboard")
                                            ? "bg-[#d4af37] text-[#0b1c2d]"
                                            : "hover:bg-[#d4af37]/10 text-[#d4af37] border border-[#d4af37]/20"
                                    }`}
                                >
                            ...
                            {user?.role === "admin" && (
                                <>
                                    ...
                                    <p className="text-[10px] text-white/20 font-black uppercase px-4 tracking-[0.2em]">
                                        الإدارة العليا
                                    </p>
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col items-start relative z-10">
                                            <span className="text-white font-black text-[11px] uppercase tracking-wider group-hover:text-[#d4af37]">
                                                إدارة الوسطاء
                                            </span>
                                            <span className="text-white/30 text-[8px] font-medium tracking-tight">
                                                Access Control
                                            </span>
                                        </div>
                                        <span className="absolute left-3 top-1/2 -translate-y-1/2 px-2 py-0.5 bg-[#d4af37] text-[#0b1c2d] text-[7px] font-black rounded-full">
                                            Pro
                                        </span>
                                    </button>
